        ...
        if (cwa.page.jsonResult.success == true) {
            ...
            if ($(tr).length == 1) {
                ...
                if (data.autoAccepted == true) {
                    estatus.replaceWith('<span><i class="bi-check-circle-fill text-success"></i> ' + cwa.page.strings.aprobado + '</span>');
                    aprobacion.text(data.aprobado);
                }
                else {
                    estatus.replaceWith('<span><i class="bi-clock-fill text-warning"></i> ' + cwa.page.strings.pendiente + '</span>');
                }
                ...
                $(row).append('<td class="align-middle"><span>' + data.actualizado + '</span></td>');

                if (data.autoAccepted == true) {
                    $(row).append('<td class="align-middle"><span><i class="bi-check-circle-fill text-success"></i> ' + cwa.page.strings.aprobado + '</span></td>')
                    $(row).append('<td class="align-middle"><span>' + data.aprobado + ' </span></td>');
                    ...
                    $(row).append('<td class="align-middle"><span><i class="bi-clock-fill text-warning"></i> ' + cwa.page.strings.pendiente + '</span></td>');
                    $(row).append('<td class="align-middle"><span>&nbsp;</span></td>');
                }
