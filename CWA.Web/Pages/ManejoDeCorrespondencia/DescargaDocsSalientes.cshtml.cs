...
{    
    public class DescargaDocsSalientes : PageModel
    {
        //Configuration
        ...
        public DescargaDocsSalientes(MCDownloadService MCDownloadService, AgenteService Agente, IConfiguration Config, IOptions<ApplicationSettings> Options)
        {
        ...
        {
            RegistroContext = new("current", "salientes");
            ...
            var startFolder = "/Documentos compartidos/Correspondencia CND/" + Usuario.Codigo + "/Saliente/";
