...
{
    public class EnmiendasModel : PageModel
    {
        // Services
        ...
        // Models
        public List<VCEnmiendaView> ViewModel { get; set; }
        ...
        public EnmiendasModel(VCService DataService, AppAccessControlService Access)
        {
            _vcdata = DataService;
            _access = Access;
        }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            RegistroContext.Add("current", "enmiendas");
            ...
            ViewModel = !ShowMore ? await _vcdata.ViewEnmiendasAsync((int)RegistroContext["agt-id"]) : await _vcdata.ViewEnmiendasAsync();
