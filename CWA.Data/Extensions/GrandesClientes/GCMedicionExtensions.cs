...
{
    public static class GCMedicionExtensions
    {
        public static void Configure<T>(this ModelBuilder builder) where T : GCMedicion
        {
            // Tipo de Medición
            builder.Entity<T>()
                .HasOne(p => p.TipoConexion)
                .WithMany()
                .HasForeignKey(fk => fk.TipoConexionId)
            ...
            builder.Entity<T>().Navigation(n => n.TipoConexion).AutoInclude();
